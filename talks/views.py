...
class TalkListDetailView(views.LoginRequiredMixin,
                         ...
                         RestrictToUserMixin, generic.DetailView):
...
class TalkListUpdateView(views.LoginRequiredMixin, views.SetHeadlineMixin, RestrictToUserMixin, generic.UpdateView):
    form_class = forms.TalkListForm
    headline = 'Update'
    model = models.TalkList


class TalkListRemoveTalkView(views.LoginRequiredMixin, generic.RedirectView):
    model = models.Talk
